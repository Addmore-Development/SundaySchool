...
const errStyle: React.CSSProperties = {
  fontSize: '0.7rem', color: '#4b5563', marginTop: '0.25rem', fontWeight: 500,
};
...
const radioOptActive: React.CSSProperties = {
  border: '1px solid #f0c000', background: 'rgba(240,192,0,0.1)', color: '#f0c000',
};
...
export default function ParentRegisterPage({ onBack, onLoginInstead, onSuccess }: Props) {
  ...
  const handleSubmit = () => {
    ...
    // ── Save to localStorage so ParentDashboard can read it ──
    try {
  ...
  if (submitted) {
    return (
      <>
        ...
        <div style={{
          minHeight: '100vh', background: '#071a0d',
          ...
          <div style={{ textAlign: 'center', padding: '2rem' }}>
            <div style={{
              ...
              boxShadow: '0 0 40px rgba(240,192,0,0.2)',
            }}>✅</div>
        ...
        <div className="pr-wrapper">
                  ...
                  <div style={{ display: 'grid', gap: '1rem' }}>
                    ...
                    <div className="pr-grid-2">
                      ...
                      <div>
                        ...
                        <input
                          className={`pr-input${errors.idNumber ? ' err' : ''}`}
                          type="text"
                        ...
                        {errors.idNumber
                          ...
                          : <span style={hintStyle}>South African ID — 13 digits</span>
                        }
                      </div>
                    </div>
                    ...
                    <div className="pr-grid-2">
                      <div>
                        ...
                        <input
                          ...
                          type="tel" placeholder="+27831234567"
                          value={form.phone} maxLength={12}
                          style={{ fontFamily: 'monospace', letterSpacing: '0.5px' }}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          type="tel" placeholder="+27831234567"
                          value={form.altPhone} maxLength={12}
                          style={{ fontFamily: 'monospace', letterSpacing: '0.5px' }}
                      ...
                      <div key={field}>
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.6rem' }}>
                          <input type="checkbox" id={field} checked={!!form[field]}
                            ...
                            style={{ width: 15, height: 15, marginTop: 2, accentColor: '#f0c000', flexShrink: 0, cursor: 'pointer' }} />
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  {step < 3
                    ...
                    : <button className="btn-gold" onClick={handleSubmit}>Create Account ✓</button>
                  }
                </div>
              </div>
            </div>
          ...
          <p style={{ textAlign: 'center', marginTop: '1rem', fontSize: '0.78rem', color: 'rgba(255,255,255,0.3)' }}>
            ...
            <button onClick={onLoginInstead}
              style={{ background: 'none', border: 'none', color: '#f0c000', fontWeight: 700, cursor: 'pointer', fontSize: '0.78rem', fontFamily: "'DM Sans', sans-serif", textDecoration: 'underline', padding: 0 }}>
              Sign in instead
            </button>
          </p>
...
.pr-brand-logo {
  ...
  font-family: 'Bebas Neue', sans-serif; font-size: 0.9rem; color: #071a0d;
}
...
.pr-icon-box {
  ...
  background: rgba(240,192,0,0.1); border: 1.5px solid rgba(240,192,0,0.3);
  border-radius: 12px;
...
.pr-step-nav {
  ...
  border-left: 1px solid rgba(240,192,0,0.12);
  border-right: 1px solid rgba(240,192,0,0.12);
...
.pr-info-box {
  background: rgba(240,192,0,0.05); border: 1px solid rgba(240,192,0,0.15);
...
.btn-gold {
  background: #f0c000; color: #071a0d;
